...
import { FeeType, Student } from '@/types';
                                            ...
                                            <SelectContent>
                                                {students.map((student) => (
                                                    <SelectItem key={student.id} value={student.id.toString()}>
                                                        {student.name} {student.meta.admission_number ? `(${student.meta.admission_number})` : ''}
                                                    </SelectItem>
                                                ))}
                                            </SelectContent>
                                        </Select>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                <Banknote className="text-muted-foreground absolute top-3 left-3 h-4 w-4" />
                                                <Input
                                                    id="amount"
                                                    type="number"
                                                    placeholder="0.00"
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                <CalendarDays className="text-muted-foreground absolute top-3 left-3 h-4 w-4" />
                                                <Input
                                                    id="payment_date"
                                                    type="date"
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-5">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-muted-foreground text-xs">Optional: Enter bank teller or receipt number.</p>
