                ...
                {filteredAssignments.length > 0 ? (
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {filteredAssignments.map((assignment) => {
                            ...
                            return (
                                <Card key={assignment.id} className="flex flex-col shadow-sm hover:shadow-md transition-all border-t-4 border-t-primary">
                                    <CardHeader className="pb-3">
                                        ...
                                        <div className="flex items-center gap-2 text-xs text-muted-foreground mt-2 font-medium">
                                            {pastDue ? <CalendarClock className="h-3.5 w-3.5 text-destructive" /> : <Clock className="h-3.5 w-3.5 text-amber-500" />}
                                    ...
                                    <CardFooter className="pt-4 border-t bg-muted/10 grid grid-cols-2 gap-2">
                                        <Button variant="outline" className="w-full text-xs gap-2" size="sm">
                                            <FileEdit className="h-3.5 w-3.5" /> Edit
                                        </Button>
                                        <Button variant="default" className="w-full text-xs gap-2" size="sm">
                    ...
                    <div className="border-muted flex min-h-[400px] flex-col items-center justify-center rounded-xl border border-dashed bg-muted/5 p-8 text-center">
                        ...
                        <p className="text-muted-foreground mt-2 max-w-sm text-sm">
                            You haven't assigned any tasks to your classes yet.
                        </p>
                        <Link href={route('assignments.create')}>
